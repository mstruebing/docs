...
export const meta = {
  ...
  lastEdited: '2019-06-15T12:10:55.000Z'
}
...
<Note hint>
  ...
  <InlineCode>@now/node</InlineCode>. Read more about this in the <GenericLink href="http://localhost:3000/docs/v2/deployments/official-builders/node-js-now-node#helpers">
