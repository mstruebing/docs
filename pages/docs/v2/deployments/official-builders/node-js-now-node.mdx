...
export const meta = {
  ...
  lastEdited: '2019-06-12T12:40:26.000Z'
}
...
module.exports = (req, res) => {
  ...
  if (action !== 'ping') {
    res.status(400)
    res.json({ error: 'The value of `action` needs to be `ping`' })
    return
  }
