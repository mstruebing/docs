...
export const meta = {
  ...
  lastEdited: '2019-06-12T09:13:07.000Z'
}
...
The following lambda example accepts a JSON body in the POST request, and returns a stringified version of it:
...
<Note>
  You can opt-out of this behaviour by setting `helpers` to `false` in the
  configuration of the builder. If you opt-out, request objects will be replaced
  by the standard HTTP{' '}
