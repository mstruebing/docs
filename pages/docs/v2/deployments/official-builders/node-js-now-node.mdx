...
export const meta = {
  ...
  lastEdited: '2019-06-11T21:36:11.000Z'
}
...
We leave the standard standard HTTP request and response objects untouched, so frameworks like [Express](http://expressjs.com/) or [micro](https://github.com/zeit/micro) will still work.
...
<Caption>Example Node.js lambda using the `req.body` helper provided</Caption>
