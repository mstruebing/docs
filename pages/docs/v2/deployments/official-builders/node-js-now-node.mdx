...
export const meta = {
  ...
  lastEdited: '2019-06-12T09:54:16.000Z'
}
...
<Caption>
  Example Node.js lambda using the `req.body` helper that returns a stringified
  version of the JSON object sent in the request
</Caption>
